...
function Videos() {
  ...
  return (
    <section className="py-10 px-6 bg-custom-beige font-baloo">
      <div className="container mx-auto text-center">
        ...
        <div className="flex justify-center gap-6 sm:gap-9 flex-wrap">
          {/* Video 1 */}
          <div
            className="bg-custom-beige text-orange-500 hover:text-orange-400 font-bold text-xl p-1 rounded-lg shadow-lg border-8 border-transparent hover:border-orange-400 hover:scale-105 transition-transform"
          ...
          >
            ...
            <h3 className="text-xl font-semibold mt-2 text-orange-500 hover:text-yellow-400">
              Chest Workout
            </h3>
          </div>
